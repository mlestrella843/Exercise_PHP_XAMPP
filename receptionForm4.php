<?php
    ...
    if($_POST){
       ...
       $txtComments=( isset( $_POST['txtComments']))?$_POST['txtComments']:"";
...
<body>
    ...
    <br/> 
    <br/>
    <strong> Message: </strong>: <?php echo $txtComments; ?>  



    <?php } ?>
   
    <form action="receptionForm4.php" method="post">
        Name: <br/>
        ...
        <textarea name="txtComments" id="" cols="30" rows="10">
